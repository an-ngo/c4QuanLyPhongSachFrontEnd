function getNameAndMoney(){
    ...
    success: function (data) {
          let content = '<img src="../../customer/img/'+data.avatar+'" style="width: 100%;height: 100%;border-radius: 100px;border: 1px solid white; alt=""/>'
      document.getElementById("money__button").innerHTML = `$${data.money}.00`;
      document.getElementById("name__button").innerHTML = `${data.name}`;
      document.getElementById("image__button").innerHTML = content;
